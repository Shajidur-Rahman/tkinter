...
button_add = Button(root, text='+', padx=30, pady=15, command=button_click)
button_equal = Button(root, text='=', padx=30, pady=15, command=button_click)
button_clear = Button(root, text="CLEAR", padx=40, pady=15, command=button_click)
